...
from domain.mr.markers import build_auth_headers, extract_leading_comment_markers
...
def run() -> None:
    ...
    mr_endpoint, headers, llm_guide, output_template, model_name, alt_model_name = load_runtime_context(
        read_required_env=read_required_env,
        env_getter=os.getenv,
        build_auth_headers=build_auth_headers,
        read_text_file=read_text_file,
        build_mr_endpoint=build_mr_endpoint,
    ...
    current_description, existing_confidence_notes, policy = fetch_policy_context(
        mr_endpoint=mr_endpoint,
        headers=headers,
        fetch_mr_description=fetch_mr_description,
        fetch_mr_notes_by_signature=fetch_mr_notes_by_signature,
    ...
    mr_changes, diff_context, confidence_context = fetch_diff_and_confidence(
        ...
        fetch_mr_changes=fetch_mr_changes,
